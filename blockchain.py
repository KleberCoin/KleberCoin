...
class Block:
    def __init__(self, data, previous_hash):
        #Attibuts de la classe Block
        #Contenu du block
        self.data = data
        #Hash du bloc précédent
        self.previous_hash = previous_hash
        #Hash du bloc (voir la méthode hash_block)
        self.hash = self.hash_block()

    #Méthode permettant d'obtenir le hash du bloc à l'aide de la fonction sha256
    def hash_block(self):
...
def create_first_block(data):
    ...
    #On choisi "0" arbitrairement comme hash du précédent bloc
    #Cette valeur n'a pas d'importance.
    return Block(data,"0")

#Fonction permettant la création d'un nouveau bloc prenant en entrée le contenu
#du nouveau bloc et la chaîne de bloc à laquelle on veut ajouter le nouveau bloc
...
class Blockchain:
    def __init__(self, first_block):
        #La classe Blockchain possède pour attribut une liste contenant les
        # blocs
